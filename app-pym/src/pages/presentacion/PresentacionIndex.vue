<template>
  <q-page class="relative bg-cover bg-center bg-no-repeat" :style="backgroundStyle">
      ...
      >
        <div class="flex flex-wrap gap-6">
          ...
          <div class="w-full lg:w-1/3">
            <div class="bg-black/50 backdrop-blur-md rounded-2xl p-6 border border-cyan-400/50 shadow-2xl h-full">
              <h2 class="text-2xl md:text-3xl font-bold text-white neon-text">
                Somos PyM Systems
              </h2>
              ...
              <div v-if="selectedTech" class="mt-6 pt-4 border-t border-cyan-400/30">
                <div class="flex items-center gap-3 mb-3">
                  <svg width="40" height="40" class="animate-float">
            ...
            <div class="space-y-8">
              ...
              <div class="tech-card p-5 md:p-6 rounded-2xl border border-cyan-300/30">
                ...
                <div class="flex flex-wrap gap-5 items-center">
                  ...
                  >
                    <svg width="40" height="40" class="p-1 transition-transform hover:scale-110">
...
const frontendTechs = [
  {
    ...
    name: 'Quasar',
    icon: 'quasar',
    description: 'Framework Vue.js que permite desarrollar aplicaciones para múltiples plataformas (web, móvil, escritorio) con un solo código base. Ofrece componentes pre-construidos y rendimiento excepcional.',
  ...
  },
  {
    ...
    name: 'Vue 3',
    icon: 'vue',
    description: 'Framework progresivo de JavaScript para construir interfaces de usuario. Vue 3 ofrece Composition API, mejor rendimiento y TypeScript mejorado, permitiendo crear aplicaciones reactivas y escalables.',
    url: 'https://vuejs.org/'
  },
  {
    id: 'html',
    name: 'HTML5',
    icon: 'html',
    description: 'Lenguaje de marcado esencial para la estructura de páginas web. HTML5 introduce elementos semánticos, soporte multimedia nativo y APIs avanzadas para aplicaciones web modernas.',
  ...
  },
  {
    ...
    name: 'CSS3',
    icon: 'css',
    description: 'Lenguaje de estilos que permite diseñar interfaces visualmente atractivas. CSS3 incluye animaciones, flexbox, grid layout y responsive design para experiencias web profesionales.',
  ...
  },
  {
    ...
    name: 'Tailwind',
    icon: 'tailwind',
    description: 'Framework CSS utility-first que permite construir diseños personalizados rápidamente sin salir del HTML. Ofrece flexibilidad, consistencia y excelente rendimiento.',
  ...
  },
  {
    ...
    name: 'Angular',
    icon: 'angular',
    description: 'Plataforma de desarrollo de aplicaciones web basada en TypeScript. Proporciona una estructura robusta con inyección de dependencias, componentes reutilizables y herramientas para aplicaciones empresariales.',
  ...
  },
  {
    ...
    name: 'PHP',
    icon: 'php',
    description: 'Lenguaje de programación del lado del servidor ampliamente utilizado para desarrollo web dinámico. Ideal para crear aplicaciones robustas y sistemas de gestión de contenido.',
...
const backendTechs = [
  {
    ...
    name: 'Node.js',
    icon: 'node',
    description: 'Entorno de ejecución de JavaScript del lado del servidor. Permite construir aplicaciones escalables y de alto rendimiento usando el mismo lenguaje tanto en frontend como backend.',
  ...
  },
  {
    ...
    name: 'ExpressJS',
    icon: 'express',
    description: 'Framework minimalista y flexible para Node.js que proporciona características robustas para aplicaciones web y APIs. Es el estándar de facto para servidores con Node.js.',
  ...
  },
  {
    ...
    name: 'SpringBoot',
    icon: 'spring',
    description: 'Framework de Java que simplifica la creación de aplicaciones empresariales. Spring Boot ofrece configuración automática, microservicios y ecosistema completo para desarrollo backend.',
  ...
  },
  {
    ...
    name: 'NestJs',
    icon: 'nestjs',
    description: 'Framework progresivo de Node.js para construir aplicaciones del lado del servidor eficientes y escalables. Utiliza TypeScript y combina elementos de OOP, FP y FRP.',
...
const databaseTechs = [
  {
    ...
    name: 'PostgreSQL',
    icon: 'pg',
    description: 'Sistema de base de datos relacional de código abierto potente y avanzado. Ofrece características como integridad transaccional, concurrencia y soporte para datos JSON.',
  ...
  },
  {
    ...
    name: 'MySQL',
    icon: 'mysql',
    description: 'Sistema de gestión de bases de datos relacional ampliamente utilizado. Es conocido por su velocidad, confiabilidad y facilidad de uso en aplicaciones web.',
  ...
  },
  {
    ...
    name: 'Oracle',
    icon: 'oracle',
    description: 'Base de datos empresarial líder en el mercado. Ofrece alto rendimiento, seguridad avanzada y características para aplicaciones críticas y big data.',
...
const devToolsTechs = [
  {
    ...
    name: 'GitHub',
    icon: 'github',
    description: 'Plataforma de desarrollo colaborativo basada en Git. Permite alojar proyectos, control de versiones, revisión de código y gestión de equipos de desarrollo.',
  ...
  },
  {
    ...
    name: 'GitLab',
    icon: 'gitlab',
    description: 'Plataforma DevOps completa que proporciona gestión de repositorios Git, CI/CD, seguimiento de problemas y despliegue continuo en un solo lugar.',
  ...
  },
  {
    ...
    name: 'Docker',
    icon: 'docker',
    description: 'Plataforma de contenedores que permite empaquetar aplicaciones y sus dependencias en entornos aislados, garantizando consistencia en desarrollo y producción.',
  ...
  },
  {
    ...
    icon: 'vc',
    description: 'Editor de código ligero pero potente desarrollado por Microsoft. Ofrece debugging inteligente, resaltado de sintaxis, control de versiones integrado y miles de extensiones.',
  ...
  },
  {
    ...
    name: 'DBeaver',
    icon: 'dbeaver',
    description: 'Cliente de base de datos universal gratuito y de código abierto. Soporta múltiples bases de datos como MySQL, PostgreSQL, Oracle, SQL Server y más.',
  ...
  },
  {
    ...
    name: 'OpenVPN',
    icon: 'openvpn',
    description: 'Solución de red privada virtual (VPN) de código abierto. Proporciona conexiones seguras y encriptadas para acceso remoto a redes privadas.',
  ...
  },
  {
    ...
    name: 'Canva',
    icon: 'canva',
    description: 'Plataforma de diseño gráfico online que permite crear diseños profesionales para interfaces, presentaciones, branding y material visual para proyectos.',
