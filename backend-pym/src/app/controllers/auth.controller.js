...
const buscarUsuario = async (req, res) => {
    ...
    try {
        ...
        if (result.rows.length === 0) {
            ...
            const { id_usuario, ci_usuario, nombre, cargo, correo, telefono, estado_wf, password, perfil, modulo } = result.rows[0];
            return { id_usuario, ci_usuario, nombre, cargo, correo, telefono, estado_wf, password, perfil, modulo }
        }
    } catch (e) {
        //console.log(e);
    }
